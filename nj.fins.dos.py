...
# Software Link: n/a                                                                                  #
# Version: 1.0.0                                                                                      #
# Tested on: PLC f/w rev.: NJ-501 (v1.11.00)                                                          #
...
if len(sys.argv) < 2:
	...
	elif sys.argv[1] == "--stop" and fins_exploit == 1:
		#change OP Mode
